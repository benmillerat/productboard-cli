...
export default class PluginIntegrationsUpdate extends BaseCommand {
  public static override description = 'Update a Productboard plugin integration'
  ...
  public override async run(): Promise<void> {
    const { args, flags } = await this.parse(PluginIntegrationsUpdate)
