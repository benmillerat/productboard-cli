...
export default class PluginIntegrationsCreate extends BaseCommand {
  public static override description = 'Create a Productboard plugin integration'
  ...
  public override async run(): Promise<void> {
    ...
    const endpoint = '/plugin-integrations'
