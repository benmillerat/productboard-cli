...
export default class CustomFieldsValuesList extends BaseCommand {
  public static override description = 'List Productboard custom field values'
  ...
  public override async run(): Promise<void> {
    const { flags } = await this.parse(CustomFieldsValuesList)
