...
export default class KeyResultsGet extends BaseCommand {
  public static override description = 'Get a Productboard key result'
  ...
  public override async run(): Promise<void> {
    const { args, flags } = await this.parse(KeyResultsGet)
