...
export default class KeyResultsUpdate extends BaseCommand {
  public static override description = 'Update a Productboard key result'
  ...
  public override async run(): Promise<void> {
    const { args, flags } = await this.parse(KeyResultsUpdate)
