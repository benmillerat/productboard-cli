...
export default class CompaniesFieldsList extends BaseCommand {
  public static override description = 'List Productboard company fields'
  ...
  public override async run(): Promise<void> {
    ...
    const endpoint = '/companies/custom-fields'
