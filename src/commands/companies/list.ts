...
import { companiesPresenter } from '../../core/presenters/companies.js'
...
export default class CompaniesList extends BaseCommand {
  public static override description = 'List Productboard companies'
