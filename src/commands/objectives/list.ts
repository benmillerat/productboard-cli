...
import { objectivesPresenter } from '../../core/presenters/objectives.js'
...
export default class ObjectivesList extends BaseCommand {
  public static override description = 'List Productboard objectives'
  ...
  public override async run(): Promise<void> {
    const { flags } = await this.parse(ObjectivesList)
