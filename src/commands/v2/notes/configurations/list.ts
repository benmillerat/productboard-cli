...
export default class V2NotesConfigurationsList extends V2BaseCommand {
  public static override description = 'List Productboard v2 beta note configurations'
  ...
  public override async run(): Promise<void> {
    ...
    outputResult(this.log, payload, {
      ...
      quiet: runtime.quiet,
      quietValue: quietIds,
      resource: 'v2/notes/configurations',
      wide: runtime.wide,
