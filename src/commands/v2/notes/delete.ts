...
export default class V2NotesDelete extends V2BaseCommand {
  public static override description = 'Delete a Productboard v2 beta note'
  ...
  public override async run(): Promise<void> {
    const { args, flags } = await this.parse(V2NotesDelete)
