...
export default class V2NotesList extends V2BaseCommand {
  public static override description = 'List Productboard v2 beta notes'
  ...
  public override async run(): Promise<void> {
    const { flags } = await this.parse(V2NotesList)
