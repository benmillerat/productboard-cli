...
export default class V2EntitiesList extends V2BaseCommand {
  public static override description = 'List Productboard v2 beta entities'
  ...
  public override async run(): Promise<void> {
    const { flags } = await this.parse(V2EntitiesList)
