...
export default class V2EntitiesRelationshipsList extends V2BaseCommand {
  public static override description = 'List Productboard v2 beta entity relationships'
  ...
  public override async run(): Promise<void> {
    const { args, flags } = await this.parse(V2EntitiesRelationshipsList)
