...
export default class JiraIntegrationsList extends BaseCommand {
  public static override description = 'List Productboard Jira integrations'
  ...
  public override async run(): Promise<void> {
    ...
    const endpoint = '/jira-integrations'
