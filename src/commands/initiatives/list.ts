...
import { initiativesPresenter } from '../../core/presenters/initiatives.js'
...
export default class InitiativesList extends BaseCommand {
  public static override description = 'List Productboard initiatives'
  ...
  public override async run(): Promise<void> {
    ...
    outputResult(this.log, payload, {
      ...
      quiet: runtime.quiet,
      quietValue: quietIds,
      presenter: initiativesPresenter,
      wide: runtime.wide,
