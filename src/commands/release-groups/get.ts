...
export default class ReleaseGroupsGet extends BaseCommand {
  public static override description = 'Get a Productboard release group'
  ...
  public override async run(): Promise<void> {
    const { args, flags } = await this.parse(ReleaseGroupsGet)
