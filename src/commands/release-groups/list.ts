...
export default class ReleaseGroupsList extends BaseCommand {
  public static override description = 'List Productboard release groups'
  ...
  public override async run(): Promise<void> {
    const {  flags } = await this.parse(ReleaseGroupsList)
