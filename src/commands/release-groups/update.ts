...
export default class ReleaseGroupsUpdate extends BaseCommand {
  public static override description = 'Update a Productboard release group'
  ...
  public override async run(): Promise<void> {
    const { args, flags } = await this.parse(ReleaseGroupsUpdate)
