...
export default class FeatureReleaseAssignmentsList extends BaseCommand {
  public static override description = 'List Productboard feature release assignments'
  ...
  public override async run(): Promise<void> {
    const { flags } = await this.parse(FeatureReleaseAssignmentsList)
