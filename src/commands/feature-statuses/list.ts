...
export default class FeatureStatusesList extends BaseCommand {
  public static override description = 'List Productboard feature statuses'
  ...
  public override async run(): Promise<void> {
    ...
    const endpoint = '/feature-statuses'
